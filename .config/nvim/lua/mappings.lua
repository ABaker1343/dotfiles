...
--vim.api.nvim_set_keymap("n", "<leader>sx", ":split<CR>", {noremap=true})

vim.api.nvim_set_keymap("n", "<leader>ra", ":%s/", {noremap=true})
...
-- terminal mappings
vim.keymap.set('n', "<leader>c", ":tabnew<CR>:terminal<CR>A", {noremap = {true}})
